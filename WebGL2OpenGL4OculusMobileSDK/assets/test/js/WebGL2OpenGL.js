(function() {
	...
	// if (typeof(ext) !== "undefined") {
		...
		// Force the window innerWidth and innerHeight
...
//		window.innerHeight = 1440;		
		...
		*/
		...
		// GL_CONSTANTS_AND_NAMES = {}; // Uncomment this line to provide a way to know the names of the GL constants.
...
//							console.log("JUDAX: " + originalFunctionName + "(" + JSON.stringify(argumentsArray) + ") intercepted! Original call result = " + result); // Uncomment this line to show the WebGL 2 OpenGL call and its result
