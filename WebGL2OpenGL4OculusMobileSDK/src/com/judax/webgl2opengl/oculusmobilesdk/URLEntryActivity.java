	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		goButton.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
		  	...
		  	try
		  	{
		  		...
		  		{
			  		createAlertDialog(URLEntryActivity.this, "JSON Exception", "Could not add the url to the url history. " + e.getMessage(), null, 1, "Ok", null, null).show();
		  		}
		  		savePreferences(url);
		  	...
		  	{
		  		createAlertDialog(URLEntryActivity.this, "Not an URL", "The text does not represent a valid URL.", null, 1, "Ok", null, null).show();
		  	}
			}
		});
		...
		removeSelectedURLsButton.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				{
		  		createAlertDialog(URLEntryActivity.this, "JSON Exception", "Could not correctly get a URL string from the JSONArray in order to reove it: " + e.getMessage(), null, 1, "Ok", null, null).show();
				}
			}
		});
		...
		clearURLHistoryButton.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
	  		createAlertDialog(URLEntryActivity.this, "Clear URL History", "Are you sure you want to clear the URL history with '" + urlHistoryURLs.length() + "' entries?", new DialogInterface.OnClickListener()
				{
					@Override
