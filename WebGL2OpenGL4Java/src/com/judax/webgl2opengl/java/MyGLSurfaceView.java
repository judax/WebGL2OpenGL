...
public class MyGLSurfaceView extends GLSurfaceView
{
	...
	private final MyGLSurfaceViewRenderer mRenderer;
	private MyActivity myActivity = null;

	public MyGLSurfaceView(MyActivity myActivity)
	{
		super(myActivity);
		...
		mRenderer = new MyGLSurfaceViewRenderer();
	...
	public void surfaceCreated(SurfaceHolder holder)
	{
		...
		myActivity.surfaceCreated();
	}
	
	public MyGLSurfaceViewRenderer getMyGLSurfaceRenderer()
	{
		return mRenderer;
	}
}
